...
#+ATTR_HTML: :alt A screenshot of the eye icon next to the filename with an arrow pointing to it.
[[image-url:https://cleandiffapp.com/images/screenshot_eye_icon.png
][annotated eye icon screenshot]]
